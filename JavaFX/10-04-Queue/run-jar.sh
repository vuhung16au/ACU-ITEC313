...
echo ""
echo "🎯 Running the JavaFX Queue Demo from JAR..."
echo "Note: A window should open with the JavaFX application"
echo ""

java --module-path "$JAVAFX_PATH" \
     --add-modules javafx.controls,javafx.fxml \
     -jar target/javafx-queue-demo-1.0.0.jar

echo ""
echo "👋 Thanks for using the JavaFX Queue Demo!"
