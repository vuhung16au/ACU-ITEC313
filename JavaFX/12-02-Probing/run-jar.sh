...
echo ""
echo "🎯 Running the JavaFX Probing Demo from JAR..."
echo "Note: A window should open with the JavaFX application"
echo ""

java --module-path "$JAVAFX_PATH" \
     --add-modules javafx.controls,javafx.fxml \
     -jar target/probing-demo-1.0.0.jar

echo ""
echo "👋 Thanks for using the JavaFX Probing Demo!"
