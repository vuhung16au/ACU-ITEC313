...
# ControlCircleWithoutEventHandling - Direct Java Execution Script
# This script runs the application directly without Maven

set -e

echo "=== ControlCircleWithoutEventHandling - Direct Execution ==="
...
if [ -n "$JAVAFX_PATH" ]; then
    java --module-path "$JAVAFX_PATH" \
         ...
         -cp "target/classes" \
         com.acu.javafx.clockpanesdemo.ControlCircleWithoutEventHandling
else
