...
# JavaFX Multiple Bounce Ball Demo - JAR Runner Script
# This script creates dependencies and runs the JAR with proper JavaFX module path

echo "🚀 JavaFX Multiple Bounce Ball Demo - JAR Runner Script"
echo "====================================="
...
echo ""
echo "🎯 Running the JavaFX Multiple Bounce Ball Demo from JAR..."
echo "Note: A window should open with the JavaFX application"
echo ""

java --module-path "$JAVAFX_PATH" \
     --add-modules javafx.controls,javafx.fxml \
     -jar target/javafx-multiplebounceball-demo-1.0.0.jar

echo ""
echo "👋 Thanks for using the JavaFX Multiple Bounce Ball Demo!"
