...
/**
 * ShowText - Demonstrates the Text class usage.
 * Based on the example from: https://liveexample.pearsoncmg.com/html/ShowText.html
 * 
 * This application shows how to:
 * - Create and position text elements
 * - Apply different fonts and styles
 * - Use colors and text effects
