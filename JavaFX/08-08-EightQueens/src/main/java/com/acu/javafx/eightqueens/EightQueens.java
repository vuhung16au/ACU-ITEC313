...
public class EightQueens extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Display queens
        for (int i = 0; i < SIZE; i++) {
            Label queenLabel = new Label("♕"); // ♕ is the Unicode for a queen
            queenLabel.setStyle("-fx-font-size: 30px; -fx-text-fill: red; -fx-font-weight: bold;");
            // display the queens at the center of the cells
            queenLabel.setAlignment(Pos.CENTER);
