@echo off
REM Single-Player Tic-Tac-Toe Game - Windows Run Script (Secondary Mode)
REM This script builds and runs the single-player mode of the Tic-Tac-Toe game using Maven
