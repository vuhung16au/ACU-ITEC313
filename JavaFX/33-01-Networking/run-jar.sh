...
# Student Client/Server App - JAR Runner Script
# This script creates dependencies and runs the JAR with proper JavaFX module path

echo "🚀 Student Client/Server App - JAR Runner Script"
echo "====================================="
...
echo ""
echo "🎯 Running the Student Client/Server App from JAR..."
echo "Note: A window should open with the JavaFX application"
echo ""

java --module-path "$JAVAFX_PATH" \
     --add-modules javafx.controls,javafx.fxml \
     -jar target/Student-Client-Server-App-1.0.jar

echo ""
echo "👋 Thanks for using the Student Client/Server App!"
