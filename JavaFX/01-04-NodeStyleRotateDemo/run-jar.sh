...
# JavaFX Node Style and Rotate Demo - JAR Runner Script
# This script creates dependencies and runs the JAR with proper JavaFX module path

echo "🚀 JavaFX Node Style and Rotate Demo - JAR Runner Script"
echo "====================================="
...
echo ""
echo "🎯 Running the JavaFX Node Style and Rotate Demo from JAR..."
echo "Note: A window should open with the JavaFX application"
echo ""

java --module-path "$JAVAFX_PATH" \
     --add-modules javafx.controls,javafx.fxml \
     -jar target/node-style-rotate-demo-1.0.0.jar

echo ""
echo "👋 Thanks for using the JavaFX Node Style and Rotate Demo!"
