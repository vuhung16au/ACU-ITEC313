 ...
 * 
 * SAM Interface Concept:
 * The EventHandler<T> interface is a functional interface (SAM interface) that
 * contains exactly one abstract method: handle(T event). This allows it to be
 * used with lambda expressions and anonymous inner classes.
 * 
...
public class AnonymousHandlerDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // This demonstrates the SAM interface concept - EventHandler<ActionEvent>
        // has exactly one abstract method: handle(ActionEvent event)
